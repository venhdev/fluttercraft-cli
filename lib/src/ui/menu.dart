...
class Menu {
  ...
  static Future<String?> select({
    ...
    // Print title
    stdout.writeln(
      '${_MenuColors.bold}${_MenuColors.cyan}$title${_MenuColors.reset}',
    );
    ...
    for (var i = 0; i < options.length; i++) {
      ...
      stdout.writeln(
        '  ${_MenuColors.bold}${i + 1})${_MenuColors.reset}$marker ${options[i]}',
      );
    }

    // Prompt for selection
    stdout.write(
      '${_MenuColors.dim}Enter number [1-${options.length}] (default: ${defaultIndex + 1}): ${_MenuColors.reset}',
    );
    ...
    if (input == null || input.isEmpty) {
      stdout.writeln(
        '${_MenuColors.green}✔ Selected: ${options[defaultIndex]}${_MenuColors.reset}',
      );
    ...
    if (number != null && number >= 1 && number <= options.length) {
      stdout.writeln(
        '${_MenuColors.green}✔ Selected: ${options[number - 1]}${_MenuColors.reset}',
      );
    ...
    stdout.writeln(
      '${_MenuColors.yellow}Invalid selection, using default.${_MenuColors.reset}',
    );
    stdout.writeln(
      '${_MenuColors.green}✔ Selected: ${options[defaultIndex]}${_MenuColors.reset}',
    );
  ...
  static Future<bool> confirm({
    ...
    stdout.write(
      '${_MenuColors.cyan}$message${_MenuColors.reset} [$defaultHint]: ',
    );
  ...
  static Future<String> prompt({
    ...
    if (defaultValue != null) {
      stdout.write(
        '${_MenuColors.cyan}$message${_MenuColors.reset} [$defaultValue]: ',
      );
    } else {
